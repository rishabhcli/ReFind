...
export class Apis extends ClientSDK {
    ...
    async createApi(request, options) {
        return unwrapAsync(apisCreateApi(this, request, options));
    }
    /**
     ...
     */
    async deleteApi(request, options) {
     ...
     */
    async getApi(request, options) {
        return unwrapAsync(apisGetApi(this, request, options));
    }
    /**
     * List API keys
     *
     ...
     */
    async listKeys(request, options) {
        return unwrapAsync(apisListKeys(this, request, options));
    }
}
