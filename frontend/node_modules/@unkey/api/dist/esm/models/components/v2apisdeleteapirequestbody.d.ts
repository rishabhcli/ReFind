...
/** @internal */
export declare const V2ApisDeleteApiRequestBody$outboundSchema: z.ZodType<V2ApisDeleteApiRequestBody$Outbound, z.ZodTypeDef, V2ApisDeleteApiRequestBody>;
export declare function v2ApisDeleteApiRequestBodyToJSON(v2ApisDeleteApiRequestBody: V2ApisDeleteApiRequestBody): string;
//# sourceMappingURL=v2apisdeleteapirequestbody.d.ts.map