...
/** @internal */
export declare const V2ApisListKeysRequestBody$outboundSchema: z.ZodType<V2ApisListKeysRequestBody$Outbound, z.ZodTypeDef, V2ApisListKeysRequestBody>;
export declare function v2ApisListKeysRequestBodyToJSON(v2ApisListKeysRequestBody: V2ApisListKeysRequestBody): string;
//# sourceMappingURL=v2apislistkeysrequestbody.d.ts.map