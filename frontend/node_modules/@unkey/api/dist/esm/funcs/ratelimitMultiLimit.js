 ...
 */
export function ratelimitMultiLimit(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => z.array(components.V2RatelimitLimitRequestBody$outboundSchema).parse(value), "Input validation failed");
    if (!parsed.ok) {
