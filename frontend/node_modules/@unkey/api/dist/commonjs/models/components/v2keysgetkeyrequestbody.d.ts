...
/** @internal */
export declare const V2KeysGetKeyRequestBody$outboundSchema: z.ZodType<V2KeysGetKeyRequestBody$Outbound, z.ZodTypeDef, V2KeysGetKeyRequestBody>;
export declare function v2KeysGetKeyRequestBodyToJSON(v2KeysGetKeyRequestBody: V2KeysGetKeyRequestBody): string;
//# sourceMappingURL=v2keysgetkeyrequestbody.d.ts.map