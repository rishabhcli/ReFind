...
/** @internal */
export declare const V2KeysAddPermissionsRequestBody$outboundSchema: z.ZodType<V2KeysAddPermissionsRequestBody$Outbound, z.ZodTypeDef, V2KeysAddPermissionsRequestBody>;
export declare function v2KeysAddPermissionsRequestBodyToJSON(v2KeysAddPermissionsRequestBody: V2KeysAddPermissionsRequestBody): string;
//# sourceMappingURL=v2keysaddpermissionsrequestbody.d.ts.map