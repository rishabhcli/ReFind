...
/** @internal */
export declare const V2KeysSetRolesResponseBody$inboundSchema: z.ZodType<V2KeysSetRolesResponseBody, z.ZodTypeDef, unknown>;
export declare function v2KeysSetRolesResponseBodyFromJSON(jsonString: string): SafeParseResult<V2KeysSetRolesResponseBody, SDKValidationError>;
//# sourceMappingURL=v2keyssetrolesresponsebody.d.ts.map