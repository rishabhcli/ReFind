...
/** @internal */
export declare const V2KeysRerollKeyRequestBody$outboundSchema: z.ZodType<V2KeysRerollKeyRequestBody$Outbound, z.ZodTypeDef, V2KeysRerollKeyRequestBody>;
export declare function v2KeysRerollKeyRequestBodyToJSON(v2KeysRerollKeyRequestBody: V2KeysRerollKeyRequestBody): string;
//# sourceMappingURL=v2keysrerollkeyrequestbody.d.ts.map