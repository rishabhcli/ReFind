...
/** @internal */
export declare const V2KeysAddRolesResponseBody$inboundSchema: z.ZodType<V2KeysAddRolesResponseBody, z.ZodTypeDef, unknown>;
export declare function v2KeysAddRolesResponseBodyFromJSON(jsonString: string): SafeParseResult<V2KeysAddRolesResponseBody, SDKValidationError>;
//# sourceMappingURL=v2keysaddrolesresponsebody.d.ts.map