...
exports.Keys = void 0;
const keysAddPermissions_js_1 = require("../funcs/keysAddPermissions.js");
const keysAddRoles_js_1 = require("../funcs/keysAddRoles.js");
const keysCreateKey_js_1 = require("../funcs/keysCreateKey.js");
const keysDeleteKey_js_1 = require("../funcs/keysDeleteKey.js");
const keysGetKey_js_1 = require("../funcs/keysGetKey.js");
const keysMigrateKeys_js_1 = require("../funcs/keysMigrateKeys.js");
const keysRemovePermissions_js_1 = require("../funcs/keysRemovePermissions.js");
const keysRemoveRoles_js_1 = require("../funcs/keysRemoveRoles.js");
const keysRerollKey_js_1 = require("../funcs/keysRerollKey.js");
const keysSetPermissions_js_1 = require("../funcs/keysSetPermissions.js");
const keysSetRoles_js_1 = require("../funcs/keysSetRoles.js");
const keysUpdateCredits_js_1 = require("../funcs/keysUpdateCredits.js");
const keysUpdateKey_js_1 = require("../funcs/keysUpdateKey.js");
const keysVerifyKey_js_1 = require("../funcs/keysVerifyKey.js");
const keysWhoami_js_1 = require("../funcs/keysWhoami.js");
const sdks_js_1 = require("../lib/sdks.js");
const fp_js_1 = require("../types/fp.js");
class Keys extends sdks_js_1.ClientSDK {
    /**
     * Add key permissions
     *
     * @remarks
     ...
     */
    async addPermissions(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysAddPermissions_js_1.keysAddPermissions)(this, request, options));
    }
    /**
     * Add key roles
     *
     ...
     */
    async addRoles(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysAddRoles_js_1.keysAddRoles)(this, request, options));
    }
    /**
     * Create API key
     *
    ...
    async createKey(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysCreateKey_js_1.keysCreateKey)(this, request, options));
    }
    /**
     * Delete API keys
     *
     ...
     */
    async deleteKey(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysDeleteKey_js_1.keysDeleteKey)(this, request, options));
    }
    /**
     * Get API key
     *
    ...
    async getKey(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysGetKey_js_1.keysGetKey)(this, request, options));
    }
    /**
     * Migrate API key(s)
     *
    ...
    async migrateKeys(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysMigrateKeys_js_1.keysMigrateKeys)(this, request, options));
    }
    /**
     ...
     */
    async removePermissions(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysRemovePermissions_js_1.keysRemovePermissions)(this, request, options));
    }
    /**
     * Remove key roles
     *
    ...
    async removeRoles(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysRemoveRoles_js_1.keysRemoveRoles)(this, request, options));
    }
    /**
     * Reroll Key
     *
    ...
    async rerollKey(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysRerollKey_js_1.keysRerollKey)(this, request, options));
    }
    /**
     * Set key permissions
     *
     ...
     * Invalidates the key cache for immediate effect, and makes permission changes available for verification within 30 seconds across all regions.
     */
    async setPermissions(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysSetPermissions_js_1.keysSetPermissions)(this, request, options));
    }
    /**
     * Set key roles
     *
    ...
    async setRoles(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysSetRoles_js_1.keysSetRoles)(this, request, options));
    }
    /**
     * Update key credits
     *
     ...
     */
    async updateCredits(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysUpdateCredits_js_1.keysUpdateCredits)(this, request, options));
    }
    /**
     * Update key settings
     *
     ...
     */
    async updateKey(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysUpdateKey_js_1.keysUpdateKey)(this, request, options));
    }
    /**
     * Verify API key
     *
     ...
     */
    async whoami(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, keysWhoami_js_1.keysWhoami)(this, request, options));
    }
}
exports.Keys = Keys;
