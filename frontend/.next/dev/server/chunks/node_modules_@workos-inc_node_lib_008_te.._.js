module.exports = [
"[project]/node_modules/@workos-inc/node/lib/factory-Dl_P8aZA.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ var SubtleCryptoProvider = class extends CryptoProvider {
    ...
    /** @override */ async secureCompare(stringA, stringB) {
...
var HttpClient = class HttpClient {
    ...
    static getResourceURL(baseURL, path, params) {
        ...
        return new URL([
            path,
            queryString
        ].filter(Boolean).join("?"), baseURL).toString();
    }
    ...
    static getContentTypeHeader(entity) {
        if (entity instanceof URLSearchParams) return {
...
const deserializeOrganization = (organization)=>({
        ...
        ...typeof organization.stripe_customer_id === "undefined" ? void 0 : {
...
const serializeListSessionsOptions = (options)=>({
        ...options
    });
//#endregion
...
const deserializeSession = (session)=>({
        ...
        ...session.organization_id !== void 0 && {
            organizationId: session.organization_id
        },
        ...session.impersonator !== void 0 && {
...
const deserializeDirectoryUser = (directoryUser)=>({
        ...
        ...directoryUser.role !== void 0 && {
            role: directoryUser.role
        },
        ...directoryUser.roles !== void 0 && {
...
const deserializeConnection = (connection)=>({
        ...
        id: connection.id,
        ...connection.organization_id !== void 0 && {
...
const deserializeProfile = (profile)=>({
        ...
        ...profile.organization_id !== void 0 && {
            organizationId: profile.organization_id
        },
        connectionId: profile.connection_id,
        connectionType: profile.connection_type,
        email: profile.email,
        ...profile.first_name !== void 0 && {
            firstName: profile.first_name
        },
        ...profile.last_name !== void 0 && {
            lastName: profile.last_name
        },
        ...profile.role !== void 0 && {
            role: profile.role
        },
        ...profile.roles !== void 0 && {
            roles: profile.roles
        },
        ...profile.groups !== void 0 && {
            groups: profile.groups
        },
        ...profile.custom_attributes !== void 0 && {
            customAttributes: profile.custom_attributes
        },
        ...profile.raw_attributes !== void 0 && {
...
var Events = class {
    ...
    async listEvents(options) {
        const { data } = await this.workos.get(`/events`, {
            query: options ? serializeListEventOptions(options) : void 0
        });
...
*/ function toQueryString(options) {
    ...
    for (const key of sortedKeys){
        ...
        if (Array.isArray(value)) for (const item of value)params.push([
            key,
            String(item)
        ]);
            ...
            for (const subKey of sortedSubKeys){
                ...
                if (subValue !== void 0) params.push([
                    `${key}[${subKey}]`,
                    String(subValue)
                ]);
            }
...
var Mfa = class {
    ...
    async challengeFactor(options) {
        const { data } = await this.workos.post(`/auth/factors/${options.authenticationFactorId}/challenge`, {
    ...
    async verifyChallenge(options) {
        const { data } = await this.workos.post(`/auth/challenges/${options.authenticationChallengeId}/verify`, {
            code: options.code
        });
...
async function generateKey(password, options) {
    ...
    let isHmac = algorithm.name === "SHA-256", id = isHmac ? {
        ...
        "encrypt",
        "decrypt"
    ], iv = options.iv || (algorithm.ivBits ? randomBits(algorithm.ivBits) : void 0);
    if (typeof password == "string") {
        ...
        let baseKey = await crypto.subtle.importKey("raw", enc.encode(password), "PBKDF2", !1, [
            "deriveKey"
        ]), algorithm$1 = {
            name: "PBKDF2",
...
const serializeResendInvitationOptions = (options)=>({
        locale: options.locale
    });
//#endregion
...
*/ function getJose() {
    return _josePromise ??= __turbopack_context__.A("[project]/node_modules/@workos-inc/node/lib/webapi-Cj8QQOwM.mjs [app-route] (ecmascript, async loader)");
}
//#endregion
...
var UserManagement = class {
	...
	*/ async authenticateWithRefreshToken(payload) {
        ...
        const { data } = await this.workos.post("/user_management/authenticate", body, {
    ...
    async getSessionFromCookie({ sessionData, cookiePassword = getEnv("WORKOS_COOKIE_PASSWORD") }) {
        if (!cookiePassword) throw new Error("Cookie password is required");
        if (sessionData) return unsealData(sessionData, {
            password: cookiePassword
        });
    }
    ...
    async createMagicAuth(options) {
        const { data } = await this.workos.post("/user_management/magic_auth", serializeCreateMagicAuthOptions({
            ...options
        }));
        return deserializeMagicAuth(data);
    }
    async verifyEmail({ code, userId }) {
        const { data } = await this.workos.post(`/user_management/users/${userId}/email_verification/confirm`, {
            code
        });
        return {
            user: deserializeUser(data.user)
    ...
    async createPasswordReset(options) {
        const { data } = await this.workos.post("/user_management/password_reset", serializeCreatePasswordResetOptions({
            ...options
        }));
        return deserializePasswordReset(data);
    }
    ...
    async sendInvitation(payload) {
        const { data } = await this.workos.post("/user_management/invitations", serializeSendInvitationOptions({
            ...payload
        }));
        return deserializeInvitation(data);
    }
...
*/ var FGA = class {
    ...
    async updateResource(options) {
        ...
        const { data } = await this.workos.put(`/fga/v1/resources/${resourceType}/${resourceId}`, {
            meta: options.meta
        });
        return deserializeResource(data);
    }
...
var Authorization = class {
    ...
    async setEnvironmentRolePermissions(slug, options) {
        const { data } = await this.workos.put(`/authorization/roles/${slug}/permissions`, {
            permissions: options.permissions
        });
        return deserializeEnvironmentRole(data);
    }
    async addEnvironmentRolePermission(slug, options) {
        const { data } = await this.workos.post(`/authorization/roles/${slug}/permissions`, {
    ...
    async setOrganizationRolePermissions(organizationId, slug, options) {
        const { data } = await this.workos.put(`/authorization/organizations/${organizationId}/roles/${slug}/permissions`, {
            permissions: options.permissions
        });
        return deserializeOrganizationRole(data);
    }
    async addOrganizationRolePermission(organizationId, slug, options) {
        const { data } = await this.workos.post(`/authorization/organizations/${organizationId}/roles/${slug}/permissions`, {
            slug: options.permissionSlug
        });
        return deserializeOrganizationRole(data);
    }
    ...
    async listPermissions(options) {
        const { data } = await this.workos.get("/authorization/permissions", {
            query: options
        });
        return {
            object: "list",
    ...
    async listRoleAssignments(options) {
        ...
        const { data } = await this.workos.get(`/authorization/organization_memberships/${organizationMembershipId}/role_assignments`, {
            query: queryOptions
        });
        return {
            object: "list",
    ...
    async listResourcesForMembership(options) {
        ...
        const { data } = await this.workos.get(`/authorization/organization_memberships/${organizationMembershipId}/resources`, {
    ...
    async listMembershipsForResource(options) {
        ...
        const { data } = await this.workos.get(`/authorization/resources/${resourceId}/organization_memberships`, {
    ...
    async listMembershipsForResourceByExternalId(options) {
        const { organizationId, resourceTypeSlug, externalId } = options;
        const { data } = await this.workos.get(`/authorization/organizations/${organizationId}/resources/${resourceTypeSlug}/${externalId}/organization_memberships`, {
            query: serializeListMembershipsForResourceOptions(options)
        });
        return {
            object: "list",
...
const deserializeListObjects = (list)=>({
        ...
        listMetadata: {
            ...list.list_metadata.after !== void 0 && {
                after: list.list_metadata.after
            },
            ...list.list_metadata.before !== void 0 && {
...
var Vault = class {
    ...
    async decrypt(encryptedData, associatedData) {
        ...
        const key = base64ToUint8Array((await this.decryptDataKey({
            keys: decoded.keys
        })).key);
        const encoder = new TextEncoder();
        const aadBuffer = associatedData ? encoder.encode(associatedData) : void 0;
...
var WorkOS = class {
	...
	*/ requireApiKey(methodName) {
    ...
    handleHttpError({ path, error }) {
        if (!(error instanceof HttpClientError)) throw new Error(`Unexpected error: ${error}`, {
            cause: error
        });
        ...
        if (response) {
            ...
            switch(status){
                ...
                default:
                    if (error || errorDescription) throw new OauthException(status, requestID, error, errorDescription, data);
...
"[project]/node_modules/@workos-inc/node/lib/index.mjs [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$node$2f$lib$2f$factory$2d$Dl_P8aZA$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@workos-inc/node/lib/factory-Dl_P8aZA.mjs [app-route] (ecmascript)");
;
//#region src/index.ts
var WorkOSNode = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$node$2f$lib$2f$factory$2d$Dl_P8aZA$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["s"] {
    /** @override */ createHttpClient(options, userAgent) {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$node$2f$lib$2f$factory$2d$Dl_P8aZA$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["A"](this.baseURL, opts, options.fetchFn);
    }
    /** @override */ createWebhookClient() {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$node$2f$lib$2f$factory$2d$Dl_P8aZA$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v"](this.getCryptoProvider());
    }
    getCryptoProvider() {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$node$2f$lib$2f$factory$2d$Dl_P8aZA$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["j"]();
    }
    /** @override */ createActionsClient() {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$node$2f$lib$2f$factory$2d$Dl_P8aZA$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["y"](this.getCryptoProvider());
    }
...
//# sourceMappingURL=node_modules_%40workos-inc_node_lib_008_te.._.js.map